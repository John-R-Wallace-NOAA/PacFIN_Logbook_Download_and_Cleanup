...
# base::load("Funcs and Data/LB Polygons Dat 25 Mar 2019.dmp") # Load if needed
# load("Funcs and Data/EEZ.Polygon.WestCoast.dmp") # Load if needed

# Centroids of logbook blocks - from Marlene Bellman
# JRWToolBox::gitAFile("https://cdn.jsdelivr.net/gh/John-R-Wallace/PacFIN_Logbook_Download_and_Cleanup@master/R/Funcs and Data/LogBookBlocks.dmp", type = 'RData', File = "Funcs and Data/LogBookBlocks.dmp")
