...
## This code is for all logbook data through 2015
...
PacFinCols <- c("RYEAR", "DRVID", "TRIP_ID", "TOWNUM", "AGID", "RPCID", "RDAY", "DDATE", "RDATE", "TOWDATE", "SET_LAT", "SET_LONG", "UP_LAT", 
      ...
      "TICKET_DATE", "DEPTH1", "PERMID_1", "LEN_ENDOR_1", "SPID", "APOUNDS", "APOUNDS_WDFW")
...
LBData.1981.2015.Nov2017 <- NULL 
for ( i in 1981:2015) 
       LBData.1981.2015.Nov2017 <- rbind(LBData.1981.2015.Nov2017, PacFIN.Logbook.Data.by.Year(i, uid = PacFIN.Login, pwd = PacFIN.PW)[,PacFinCols]) # Downloading a few colums that are not used 

# Saved again later with bimo and Key columns and other changes, saved the raw data here because of the long download time. 
save(LBData.1981.2015.Nov2017, file = "Funcs and Data/LBData.1981.2015.Nov2017.dmp")  
...
head(LBData.1981.2015.Nov2017)

# The PacFIN SQL functions: pfutil.bimon_period() and pfutil.undelimit() no longer exist.
# Kayleigh Somers has had Rob Ames make new SQL scripts for the logbook extraction (Talked to Kayleigh on 27 Sept 2015).  
...
Table(LBData.1981.2015.Nov2017$RYEAR, LBData.1981.2015.Nov2017$AGID)  # JRWToolBox::Table() function defaults to show the NA's, unlike table(). Seeing the NA's is alsmost always important in fisheries work.
...
# import.sql("Select * from pacfin.lbk_trip where rownum < 11 and AGID = 'W' and RYEAR  = 1984", dsn="PacFIN", uid=PacFIN.Login, pwd=PacFIN.PW) # No data for WA nor OR ('O') before 19987

# # Compare to older data - the numbers by year and state agency are equal
# base::load('Funcs and Data/LBData.1981.2015.dmp') # Sept 2016
# Table(LBData.1981.2015$RYEAR, LBData.1981.2015$AGID) - Table(LBData.1981.2015.Nov2017$RYEAR, LBData.1981.2015.Nov2017$AGID)
...
LBData.1981.2015.Nov2017$DDATE <- as.Date(LBData.1981.2015.Nov2017$DDATE, "%d-%b-%Y")
LBData.1981.2015.Nov2017$RDATE <- as.Date(LBData.1981.2015.Nov2017$RDATE, "%d-%b-%Y")
LBData.1981.2015.Nov2017$bimo <- ceiling(as.numeric(recode.simple(months(LBData.1981.2015.Nov2017$RDATE, T) , cbind(c("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"), 1:12)))/2)
LBData.1981.2015.Nov2017$SET_LONG <- - LBData.1981.2015.Nov2017$SET_LONG
LBData.1981.2015.Nov2017$UP_LONG <- - LBData.1981.2015.Nov2017$UP_LONG

# Create a unique tow key 
LBData.1981.2015.Nov2017$Key <- paste(LBData.1981.2015.Nov2017$AGID, LBData.1981.2015.Nov2017$TRIP_ID, LBData.1981.2015.Nov2017$TOWNUM)  
length(unique(LBData.1981.2015.Nov2017$Key)) # 1,114,030  (Old = 1,114,030)

# # Add even more items to a test key to check uniqeness
# TestKey <- paste(LBData.1981.2015.Nov2017$AGID, LBData.1981.2015.Nov2017$TRIP_ID, LBData.1981.2015.Nov2017$TOWNUM, LBData.1981.2015.Nov2017$RYEAR, LBData.1981.2015.Nov2017$DRVID) 
# length(unique(TestKey))  # 1,114,030 - same as above
# rm(TestKey)
